...
- Typed note placement and cross-page text/label search
...
the chip above the canvas. Click a page or layer name in the sidebar to rename it.
...
- No object resize/rotation handles, rich-text spans, handwriting recognition, audio recording,
  collaboration, or cloud sync yet.
